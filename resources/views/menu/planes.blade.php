    ...
    <div class="container">
        <section>
            <div class="container py-5">
                ...
                <header class="text-center mb-5 bg-dark text-light p-3">
                    <div class="row">
                        <div class="col-lg-12 mx-auto">
                            <h1 class="text-warning border border-dark p-2">Suscripcion al taller</h1>
                            <h3 class="text-warning border border-dark p-2">UNETE AL EQUIPO</h3>
                        </div>
                    </div>
                </header>
                        ...
                        <div class="col-lg-4 mb-5 mb-lg-0">
                            <div class="bg-gray-200 p-5 rounded-lg shadow">
                                ...
                                <ul class="list-unstyled my-5 text-small text-left font-weight-normal">
                                    <li class="mb-3">
                                        <i class="fa fa-check mr-2 text-primary"></i> Ver todo el contenido
                                    {{-- </li>
                                    <li class="mb-3">
                                        <i class="fa fa-check mr-2 text-primary"></i> Sed ut perspiciatis
                                    </li>
